...
@javax.servlet.sip.annotation.SipServlet(loadOnStartup=1, applicationName="SipRegistarClient25")
public class SipRegistarClient25 extends SipServlet implements Servlet {
