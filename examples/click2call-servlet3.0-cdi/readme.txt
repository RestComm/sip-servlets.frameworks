This version of the Click-To-Call incorporates Mobicents CDI integration. Several functions of the application have been moved to simple
beans. The CDI container is responsible to inject and make available these beans. 
...
And deploy the generated war file to MSS 2.x on Tomcat.
